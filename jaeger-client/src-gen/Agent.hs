...
write_EmitZipkinBatch_args :: (T.Protocol p, T.Transport t) => p t -> EmitZipkinBatch_args -> P.IO ()
write_EmitZipkinBatch_args oprot record = T.writeVal oprot $ from_EmitZipkinBatch_args record
encode_EmitZipkinBatch_args :: (T.Protocol p, T.Transport t) => p t -> EmitZipkinBatch_args -> LBS.ByteString
...
read_EmitZipkinBatch_args :: (T.Transport t, T.Protocol p) => p t -> P.IO EmitZipkinBatch_args
read_EmitZipkinBatch_args iprot = to_EmitZipkinBatch_args <$> T.readVal iprot (T.T_STRUCT typemap_EmitZipkinBatch_args)
decode_EmitZipkinBatch_args :: (T.Protocol p, T.Transport t) => p t -> LBS.ByteString -> EmitZipkinBatch_args
...
from_EmitZipkinBatch_result record = T.TStruct $ Map.fromList $ M.catMaybes
  []
write_EmitZipkinBatch_result :: (T.Protocol p, T.Transport t) => p t -> EmitZipkinBatch_result -> P.IO ()
write_EmitZipkinBatch_result oprot record = T.writeVal oprot $ from_EmitZipkinBatch_result record
encode_EmitZipkinBatch_result :: (T.Protocol p, T.Transport t) => p t -> EmitZipkinBatch_result -> LBS.ByteString
...
read_EmitZipkinBatch_result :: (T.Transport t, T.Protocol p) => p t -> P.IO EmitZipkinBatch_result
read_EmitZipkinBatch_result iprot = to_EmitZipkinBatch_result <$> T.readVal iprot (T.T_STRUCT typemap_EmitZipkinBatch_result)
decode_EmitZipkinBatch_result :: (T.Protocol p, T.Transport t) => p t -> LBS.ByteString -> EmitZipkinBatch_result
...
write_EmitBatch_args :: (T.Protocol p, T.Transport t) => p t -> EmitBatch_args -> P.IO ()
write_EmitBatch_args oprot record = T.writeVal oprot $ from_EmitBatch_args record
encode_EmitBatch_args :: (T.Protocol p, T.Transport t) => p t -> EmitBatch_args -> LBS.ByteString
...
read_EmitBatch_args :: (T.Transport t, T.Protocol p) => p t -> P.IO EmitBatch_args
read_EmitBatch_args iprot = to_EmitBatch_args <$> T.readVal iprot (T.T_STRUCT typemap_EmitBatch_args)
decode_EmitBatch_args :: (T.Protocol p, T.Transport t) => p t -> LBS.ByteString -> EmitBatch_args
...
from_EmitBatch_result record = T.TStruct $ Map.fromList $ M.catMaybes
  []
write_EmitBatch_result :: (T.Protocol p, T.Transport t) => p t -> EmitBatch_result -> P.IO ()
write_EmitBatch_result oprot record = T.writeVal oprot $ from_EmitBatch_result record
encode_EmitBatch_result :: (T.Protocol p, T.Transport t) => p t -> EmitBatch_result -> LBS.ByteString
...
read_EmitBatch_result :: (T.Transport t, T.Protocol p) => p t -> P.IO EmitBatch_result
read_EmitBatch_result iprot = to_EmitBatch_result <$> T.readVal iprot (T.T_STRUCT typemap_EmitBatch_result)
decode_EmitBatch_result :: (T.Protocol p, T.Transport t) => p t -> LBS.ByteString -> EmitBatch_result
